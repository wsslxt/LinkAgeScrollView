...
-(void)setTitltesViewNormal:(UIButton *)btn{
    ...
    btn.selected = YES;
    [btn setTitleColor:[UIColor colorWithRed:3/225.0  green:169/255.0 blue:224/255.0 alpha:1] forState:UIControlStateNormal];
...
-(UILabel *)animationLineLab{
    if (!_animationLineLab) {
        ...
        _animationLineLab.backgroundColor = [UIColor colorWithRed:3/225.0  green:169/255.0 blue:224/255.0 alpha:1];
    }
